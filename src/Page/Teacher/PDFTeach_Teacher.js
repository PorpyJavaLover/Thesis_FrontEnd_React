    ...
    return (
      ...
      >
        <div>
          ...
          <p
            style={{ textIndent: "4.5em", lineHeight: "30px" }}
...
จึงขออนุญาตให้ ${this.props.dataAAA.nameReplaceShort}${this.props.dataAAA.nameReplaceFirst} ${this.props.dataAAA.nameReplaceLast} ทำการสอนแทน ดังนี้`}</p>
        </div>
        <br />
        <div>
          <table
        ...
        <div>
          ...
          <p style={{ textIndent: "7em" }}>
            ({" "}
            {`${this.props.dataAAA.nameTeachingShort} ${this.props.dataAAA.nameTeachingFirst} ${this.props.dataAAA.nameTeachingLast}`}
            )
          </p>
          <br />
          <p
          ...
          <p style={{ textIndent: "7em" }}>
            ({" "}
            {`${this.props.dataAAA.nameReplaceShort} ${this.props.dataAAA.nameReplaceFirst} ${this.props.dataAAA.nameReplaceLast}`}
            ){" "}
          </p>
        </div>
        <br />
