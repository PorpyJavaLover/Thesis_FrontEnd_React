...
//import APIService from "../Subject/ReplaceAPIService";
    ...
    <Paper sx={{ maxWidth: 1000, margin: "auto", overflow: "hidden" }}>
          ...
          <form onSubmit={handleSubmit}>
            <Grid container sx={{ pt: 2 }} spacing={2}>
              ...
              <Grid sx={{ minWidth: 10 }} item xs={3}>
                <label>วิชา</label>
                <Box>
                  <FormControl sx={{ m: 1, minWidth: 160 }} required>
      ...
      <Typography>
        <Stack
          direction="row"
          spacing={2}
          sx={{ m: 1, minWidth: 160, marginLeft: 50 }}
        >
          <Button
            variant="contained"
            color="success"
            onClick={() => Navigate("../view-replace")}
          >
            บันทึก
          </Button>
