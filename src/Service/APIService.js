...
export default new (class APIService {
  ...
  getMemberTime(mId) {
    return axios.get(
      API_REST_URL + "/timetable/teacher/show/member/time/" + mId,
      { headers }
    );
  }
  ...
  getStartTime(yId, sId, cId, gId, dayOfWeek, endTime) {
    return axios.get(
      API_REST_URL +
        "/timetable/staff/show/start/time" +
        "/" +
        yId +
        "/" +
        sId +
  ...
  updateDayAndTimeStaff(yId, sId, cId, gId, dayOfWeek, timeStart, timeEnd) {
    ...
    return axios.put(
      API_REST_URL +
        "/timetable/staff/update/daytime" +
        "/" +
        yId +
        "/" +
        sId +
  ...
  createNotTeach(dayOfWeek, timeStart, timeEnd) {
    ...
    return axios.post(API_REST_URL + "/notteach/teacher/create", body, {
      headers,
    });
  }
  ...
  updateNotTeach(notId, dayOfWeek, timeStart, timeEnd) {
    ...
    return axios.put(
      API_REST_URL + "/notteach/teacher/update" + "/" + notId,
      body,
      { headers }
    );
  }
  ...
  deleteNotTeach(notId) {
    return axios.delete(
      API_REST_URL + "/notteach/teacher/delete" + "/" + notId,
      { headers }
    );
  }
  ...
  createTimetable(yId, sId, cId, gId) {
    ...
    return axios.post(API_REST_URL + "/timetable/teacher/create ", body, {
      headers,
    });
  }
  ...
  deletTimetable(yId, sId, cId, gId) {
    return axios.delete(
      API_REST_URL +
        "/timetable/teacher/delete/forPlan" +
        "/" +
        yId +
        "/" +
        sId +
  ...
  createTimetableStaff(yId, sId, cId, gId, mId) {
    ...
    return axios.post(API_REST_URL + "/timetable/create/staff ", body, {
      headers,
    });
  }
  ...
  deletTimetableStaff(yId, sId, cId, gId, mId) {
    axios.delete(
      API_REST_URL +
        "/timetable/delete/teaching/staff" +
        "/" +
        yId +
        "/" +
        sId +
