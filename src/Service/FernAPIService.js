...
class FernAPIService {
  createLeaveTeach(semester, year, dateStart, dateEnd, note) {
    ...
    return axios.post(API_REST_URL + "/leaveteach/teacher/create ", body, {
      headers,
    });
  }

  updateTeacherLeaveTeach(
    leaveTeachId,
    year,
    semester,
    dateStart,
    ...
    return axios.put(
      API_REST_URL + "/leaveteach/teacher/update" + "/" + leaveTeachId,
      body,
      { headers }
    );
  }
  ...
  deleteTeacherLeaveTeach(leaveTeachId) {
    return axios.delete(
      API_REST_URL + "/leaveteach/teacher/delete" + "/" + leaveTeachId,
      { headers }
    );
  }

  showAllTeacherLeaveTeach() {
    return axios.get(API_REST_URL + "/leaveteach/teacher/show/all ", {
      headers,
    });
  }
